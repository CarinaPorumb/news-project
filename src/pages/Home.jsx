	...
	return (
		<Layout>
			...
			<section className="books my-5">
				<Container>
					<h1 className="category">Books</h1>
			...
			<section className="favorites my-5">
				<Container>
					...
					<p className="pb-3 textStyle">
						Visit the <Link to="/favorites" className="linkStyle">Favourites</Link> section to see the news you've added.
					</p>
				</Container>
			</section>
		</Layout>
